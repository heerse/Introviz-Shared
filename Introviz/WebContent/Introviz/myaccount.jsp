...
<div class="shc" >
 		...
 		<div class="admin" align="center"><h3>Hi <%out.println(name);%>,Welcome to your Account</h3>
 		<h5 align="center">
 		Your Last Login Details: <%out.println((String)session.getAttribute("usernamet")); %><br><br>
 		<%--<a href="#">Your Download Details</a>--%><br><br>
 		<a class="fancybox fancybox.iframe" href="changepwd.jsp">Change Password?</a>
 		</h5></div>
</body>
</html>
